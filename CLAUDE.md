...
| Desglose de dinero que ve el CLIENTE (ledger, «Mis pedidos») | `docs/specs/desglose-dinero-cliente.md` 🟦 — **TANDA A EJECUTADA** (§15: el dominio ya dice la verdad; **lo siguiente es la tanda B, la proyección**) · marco decidido en `DECISIONES #127`. **Empieza por §9 y §10, no por el principio**: §9.2 son **CUATRO defectos de DOMINIO** que las dos auditorías anteriores no llegaron a construir —y **el peor, el pedido cancelado sin reembolsar, no lo caza ninguna identidad**— · §9.3, la proyección son **cuatro** defectos y no uno · **§10: los DOS EJES CERRADOS, verificados en 58 de 58 pedidos reales** · §9.4, las trampas de método · §11, el plan (**A** dominio+guardas · **B** proyección · **C** pantalla) · §4.quater, la receta y las CUATRO puertas de `OrderCreator` |
