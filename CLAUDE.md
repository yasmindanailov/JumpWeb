...
| Desglose de dinero que ve el CLIENTE (ledger, «Mis pedidos») | `docs/specs/desglose-dinero-cliente.md` 🟦 — **auditado sobre 11 pedidos REALES** (**§3 + §4.ter: NO hay dos fuentes de verdad y la aritmética es robusta; panel y cliente coinciden en los once** · **§4.ter.1: el descuadre solo aparece CUANDO LA FRANJA YA PASÓ — falta «Pagado en el parque»** · **§4.quater: la receta para reproducir la auditoría y las CUATRO puertas de `OrderCreator`**) · `docs/INVARIANTES.md` §1 · las TRES TANDAS, en `00-REFACTOR.md` |
