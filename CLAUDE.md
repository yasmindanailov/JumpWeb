...
| Sidebar SPA (Fase 4) / Vue / tema por instalación | `docs/specs/sidebar-spa.md` (**§4.2–§4.3: los nombres de clase son CONTRATO**) · `docs/specs/api-v1.md` §10 → §10.quaterdecies |
...
| API v1 / SPA sidebar / app móvil | `docs/specs/api-v1.md` (Fase 3, 🟦 — **§10 → §10.quaterdecies «lo que el código enseñó», antes de tocar nada**) · `openapi/v1.yaml` (el CONTRATO: manda sobre el código) · `docs/DECISIONES.md` #21, #24, #26–#37, #39 |
