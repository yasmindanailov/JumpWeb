...
final class Contract
{
    ...
    public const EVENTS = [
        ...
        // Los emite el controlador de cada página enfocada por `Recorder::factOfOrder()`: `order_id`, la
        // `reservation` (el id de la línea del pack, porque un pedido puede tener dos fiestas y el embudo cuenta
        // por reserva) y nada más. `days_before` son los días del PARQUE que faltan para la fiesta; `device` y
