 ...
 * Es «el papelito de la excursión»: uno por pedido, que él pasa por WhatsApp, correo o impreso.
 *
...
class GuardianAuthorizationRequest extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('emails.guardian_request.subject', ['code' => $code]))
            ->greeting(__('emails.guardian_request.greeting'))
            ->line(__('emails.guardian_request.intro', ['code' => $code]))
            ...
            ->action(
                ...
                // cliente: `Order::guardianAuthorizationSignedUrl()`. Dos sitios que acuñaran la URL
                // por su cuenta acabarían con dos caducidades distintas de la misma reserva.
                $this->order->guardianAuthorizationSignedUrl(),
            )
