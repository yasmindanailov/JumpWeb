...
- [ ] Google Business Profile (`#524`, lo lleva SPA): **T1 CERRADA** (`#720`→`#726`) y **T2·1→T2·7 EN EL ÁRBOL** (`#727`→`#733`): las tablas con sus plazos, la pasada diaria —**se escribe lo visto, se borra solo con una coherente**—, las **imágenes desde nuestro servidor**, **«Ocultar»** y la **fuente nueva con cascada de TRES**. Detalle en §4.1. ⚠️ **Places NO se retira** (`[owner]` 21-09): `img-src` sigue nombrando a Google; **la portada real vive en la instancia**. ▶ Ojo del owner 21-09 ✅; falta **la tarjeta (T2·8)**, el botón del panel, el texto de privacidad y retirar Places; más JumpSystem y los 60 días.
