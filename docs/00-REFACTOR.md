...
- [ ] T6 de la celebración, el aterrizaje (§10.8–§10.12): **T6·1 ✅ el bloque** (`#708`) · **T6·2 ✅ propuestas y adopción** (`#709`, el caso intercalado) · **T6·3 ✅ «no vienen», «no caben» y «no lo apuntes»** (`#710`, el suelo medido, sin tocar `GuestCountAdjuster`) · **T6·4 ✅ puerta y hoja** (`#711`, los tres estados y «8 de 12», por lotes bajo el techo de 28) · **T6·5 ✅ el panel** (`#712`, el botón que le faltaba a `#576`); arneses 8/8 · 6/6 · 8/8 · 9/9 · 7/7. Sigue la T6·6 y la T7.
