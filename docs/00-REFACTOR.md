...
- [ ] T7 · los correos, **partida en tres** (§10.14, `#714`; cruza al carril de correos, avisado): **T7·1 ✅** el correo del post-form (`#715`, §10.15, arnés 8/8) · **T7·2a ✅** el lector de «qué queda por hacer» (`#716`, §10.16, arnés 10/10; sus tres supervivientes eran casos que faltaban, y uno evitaba mandar al parque lo que se paga por web) · **T7·2b** el aviso de la víspera a las **18:00 del día antes** (`[DECIDIDO owner]`), con comando, scheduler y marca. Inventario 25 → 26.
