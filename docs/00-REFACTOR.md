...
- [ ] Analítica (`specs/analitica.md` §0, `#678`): T1 ✅ · **T2 🟦** (T2e ⬜) · T3 ✅ · T4 ✅ · **T5 🟦** (T5c ⬜, `#738`) · **T6 ⬜** la fiesta (`specs/analitica-fiesta.md`)
- [ ] Landing nueva e isla (`specs/isla-y-landing-nueva.md` §0, `#681`·`#682`): T0→T2 ✅ · **T3 🟦** (T3a→T3e·5 ✅ 24-09 · T3e·6 ⬜) · T4→T6 ⬜
