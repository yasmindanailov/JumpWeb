...
- [ ] Landing nueva e isla (`specs/isla-y-landing-nueva.md` §0, `#681`·`#682`): T0→T3 ✅ (sonda: staging, v2.0.0) · **T4 🟦** (§4.12) · **T5 🟦** (§4.13) · T6 ⬜
...
- [ ] ▶ **LA FIESTA DEL SISTEMA NUEVO** (`specs/fiesta-sistema-nuevo.md` ✅ `#743`): T0→T4 ✅ · F1 ✅ (la invitación) → **el ojo del owner** → F2…Fn (la lista y el recibo).
