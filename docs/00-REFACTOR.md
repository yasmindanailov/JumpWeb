...
- [ ] Google Business Profile (`#524`, lo lleva el SPA): **T1 CERRADA** (`#720`→`#726`) y **T2·1→T2·6 EN EL ÁRBOL** (`#727`→`#732`): las tablas con sus plazos, la pasada diaria —**se escribe lo que se vio, se borra solo con una coherente**—, las **imágenes desde nuestro servidor**, **«Ocultar»** y la **fuente nueva con su cascada de TRES**. Detalle en §4.1. ⚠️ **Places NO se retira** (`[owner]` 21-09): `img-src` sigue nombrando a Google, y **la portada real vive en la instancia**. ▶ Faltan el botón del panel, el texto de privacidad y retirar Places; más el proyecto de JumpSystem y los 60 días de la ficha.
