...
- [ ] Analítica (`specs/analitica.md`): T1 ✅ · **T2 🟦** (T2e ⬜) · T3 ✅ · T4 ✅ · **T5 🟦** (T5c ⬜) · **T6 ✅** (`specs/analitica-fiesta.md`) · **T7 🟦** encuestas (ojo)
- [ ] Landing nueva e isla (`specs/isla-y-landing-nueva.md` §0, `#681`·`#682`): T0→T3 ✅ (sonda: staging, v2.0.0) · **T4 🟦** (§4.12) · T5→T6 ⬜
...
- [ ] ▶ **LA FIESTA DEL SISTEMA NUEVO** (`specs/fiesta-sistema-nuevo.md` ✅ `#743`): T0 ✅ → T1a ✅ → **T1b (pasada ligera)** → T2 invitación → T3 autorización → T4 piel vieja fuera → F1…Fn.
