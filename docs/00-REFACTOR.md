...
- [ ] F5 · instancia PlayJump y la landing fuera, v2.0.0 · **ABIERTA el 19-09 por el CENSO** (`specs/instancia-y-landing-fuera.md` ✅, `#639`). **T1 · el MENÚ, SERVIDO** (`#640`→`#646`; hoy contrato **1.11.0**): `site`, horario, normas, legales, precios, la ficha de producto y zona, y la cifra de prueba social. **T2a ✅** (`specs/paquete-de-instancia.md`, `#647`): el namespace `instancia::`, el invariante **`SEC-12`**, la `plantilla/` y el repo de instancia. **T2b en curso** (`#649`→`#654`): el contrato producto↔instancia son los DATOS de la vista, no su HTML; nace el contrato de vista, tres reglas bajan al producto y **`/contacto` está MUDADA** (`#654`: anfitrión mínimo, suite SIN paquete, huella 0). ▶ Siguen las otras ocho vistas y T3–T5
