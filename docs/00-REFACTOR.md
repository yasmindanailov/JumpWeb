...
- [ ] T6 de la celebración, el aterrizaje (§10.8–§10.10): **T6·1 ✅ el bloque** (`#708`, POST propio y el testigo no se mueve) · **T6·2 ✅ propuestas y adopción** (`#709`, el caso intercalado) · **T6·3 ✅ «no vienen», «no caben» y «no lo apuntes»** (`#710`, el suelo medido y sin tocar `GuestCountAdjuster`); arneses 8/8 · 6/6 · 8/8. Siguen T6·4→T6·6 y la T7.
