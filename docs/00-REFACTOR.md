...
- [ ] T4 · la invitación digital, partida en seis unidades verdes (spec §10.4): **T4·1 cimientos** (`#573`) y **T4·2 reglas del dominio** (`#574`, con concurrencia verificada sobre InnoDB) hechas; quedan T4·3 catálogo → T4·4 plazas y firmador → T4·5 RGPD → T4·6 API.
