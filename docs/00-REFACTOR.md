...
- [ ] Analítica (`specs/analitica.md`): T1 ✅ · **T2 🟦** (T2e ⬜) · T3 ✅ · T4 ✅ · **T5 🟦** (T5c ⬜) · **T6 ✅** (`specs/analitica-fiesta.md`) · **T7 ⬜** encuestas (spec antes)
- [ ] Landing nueva e isla (`specs/isla-y-landing-nueva.md` §0, `#681`·`#682`): T0→T2 ✅ · **T3 ✅** (su sonda, en staging con la v2.0.0) · T4→T6 ⬜
