...
- [x] T6 de la celebración, el aterrizaje, **CERRADA en seis unidades** (§10.8–§10.13, `#708`→`#713`): el bloque · propuestas y adopción (el caso intercalado) · «no vienen» y «no lo apuntes» (el suelo medido, sin tocar `GuestCountAdjuster`) · puerta y hoja («8 de 12» bajo el techo de 28) · el panel (el botón que faltaba a `#576`) · el recordatorio, que **NO envía nada**; arneses 8/8 · 6/6 · 8/8 · 9/9 · 7/7 · 13/13. ▶ Encender la invitación es DATO del owner. Sigue la **T7** (correos, §4.9).
