...
- [ ] F5 · instancia PlayJump y la landing fuera, v2.0.0 · **ABIERTA el 19-09 por el CENSO** (`specs/instancia-y-landing-fuera.md` ✅, `#639`: tres decisiones del owner contestadas; el censo, en su §1). **El MENÚ, cuatro platos servidos** (`#640`→`#643`, contrato **1.6.0**, arnés 21/21): `/site` con lista blanca —y un secreto no sale ni declarándolo—, el horario en dos rutas por cómo se cachean, las normas y los legales. ▶ Siguen precios, fichas y prueba social
