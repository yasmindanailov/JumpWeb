...
- [ ] F4 · cajón empaquetable y login por token, contrato 1.1.0 · ABIERTA el 2026-09-18 con dos specs en ⬜ borrador, medidas: `specs/token-bearer.md` (completa; el owner decide la duración, §4.4) y `specs/cajon-empaquetable.md` (§4.5 el arranque y §4.6 lo que consume la landing, en iteración con el owner) · cero código hasta aprobarlas
