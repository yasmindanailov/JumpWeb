...
|---|---|---|---|---|
| 🏗️ Plataforma · producto e instancias | este ordenador (`~/proyectos/jumpweb/producto`, `#648`) | **670–699** | `carriles/plataforma.md` | **F0–F4 ✅** · v1.2.0 etiquetada y **sin desplegar**: producción sigue en v1.1.0 hasta la v2.0.0 grande (`#670`) · **F5**: T2a→T2c, T3·1 y T4 hechas; la **vía A** con su **menú de hechos COMPLETO** (`#671`→`#677`, contrato **1.17.0**) · **la analítica** en marcha (`#678`, contrato **1.19.0**): **T1 ✅** (libro, emisor, correos, pedido manual, derechos; arnés 19/19; `SEC-13`) · la analítica, ENTERA del SPA (`#735`) · aquí: **la LANDING NUEVA y la ISLA** (`specs/isla-y-landing-nueva.md` ⬜; `#681` páginas en Blade dentro de la instancia, `#682` la isla como segunda carcasa del producto): **T1 ✅** (la hoja de Saltia, 82/82 páginas a 0 px) · **T2 ✅** (la isla en Vue, 52/52 situaciones a 0 px) · **T3**, la compra en la isla: T3a→T3d ✅ (piezas y pantallas a 0 px; la secuencia de compra, compartida con el cajón en `usePurchaseFlow.js`, `#691`) → T3e: ·1→·4 ✅, la isla compra con tarjeta hasta el banco y sus desenlaces (`#693`, `#694`, contrato **1.24.0**), con «Entra» y Google, que vuelve a la compra (`#695`) → ·5 cumpleaños |
