...
> Suite **4850 en verde** (30.904 aserciones, 1 skipped), medida el **2026-09-13** con `#588` y `#589` en el
> árbol (**+22** sobre `#568`: la edad del cumpleañero, los servicios con varios productos, los regalos, la
> escala de altura sin franjas pisadas y el horario «sábado y domingo»). Verificadores de concurrencia en
