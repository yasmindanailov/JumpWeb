...
|---|---|---|---|---|
| 🏗️ Plataforma · producto e instancias | este ordenador | 610–639 | `carriles/plataforma.md` | F2 a falta del owner (plugin y frases); F3 hecha salvo que producción diga v1.0.0 |
