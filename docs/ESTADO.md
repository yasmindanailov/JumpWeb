...
>
> ❗❗ **LO SIGUIENTE: LA PARADA 02 DEL CANVAS** — los cuatro primeros pasos vestidos (catálogo, día,
> hora y cesta). El catálogo ya lo hicieron `#552`/`#553`, así que empieza por el **día** y la **hora**,
> que es «el paso más cargado con diferencia» según el propio canvas. ⚠️ Con una negociación
