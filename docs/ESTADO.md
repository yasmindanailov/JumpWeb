...
> Suite **4861 en verde** (30.962 aserciones, 1 skipped), medida el **2026-09-13** con `#592` en el árbol
> (**+6**: la sección de reseñas con la nota y el aviso cuando solo falta el permiso, y la política de
> cookies que nombra las reseñas; antes, **+5** con `#591`: las reseñas de Google en el idioma de la
