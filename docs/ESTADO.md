...
|---|---|---|---|---|
| 🏗️ Plataforma · producto e instancias | este ordenador (`~/proyectos/jumpweb/producto`, `#648`) | **670–699** → **760–789** | `carriles/plataforma.md` | **F0–F4 ✅** · v1.2.0 etiquetada y **sin desplegar**: producción sigue en v1.1.0 hasta la v2.0.0 grande (`#670`) · **F5**: T2a→T2c, T3·1 y T4 hechas; la **vía A** con su **menú de hechos COMPLETO** (`#671`→`#677`, contrato **1.17.0**) · **la analítica** en marcha (`#678`, contrato **1.19.0**): **T1 ✅** (libro, emisor, correos, pedido manual, derechos; arnés 19/19; `SEC-13`) · la analítica, ENTERA del SPA (`#735`) · aquí: **la LANDING NUEVA y la ISLA** (`specs/isla-y-landing-nueva.md` ⬜; `#681` páginas en Blade dentro de la instancia, `#682` la isla como segunda carcasa del producto): **T1 ✅** (la hoja de Saltia, 82/82 páginas a 0 px) · **T2 ✅** (la isla en Vue, 52/52 situaciones a 0 px) · **T3 ✅**, la compra en la isla (`#689`→`#698`: con tarjeta hasta el banco y sus desenlaces, «Entra» y Google, cumpleaños con señal, la hora que se llena; contrato **1.25.0**; `scripts/sonda-isla.mjs`) · el sistema de diseño nuevo del 24-09, dentro (`#697`) · **T4, Kids y Jump** (`#761`→`#764`): T4c ✅ (las ocho piezas y el pie a 0 px, las páginas enteras con los hechos en es/en/fr) y **T4d ✅** (la calculadora, igual al diseño y EN VIVO: «Reservar y pagar» → «Tus datos»; `scripts/sonda-calculadora.mjs`) → la forma de vídeo de las atracciones y la T4e, la isla viva en la página |
| 🎨 Diseño de la web | este ordenador | 580–609 | `carriles/web.md` | todo en producción (13-09); sigue la T6 de copys |
| 🧩 Diseño del SPA (el cajón) | el otro ordenador | 730–759 (`#729` agotó la 700–729) | `carriles/spa.md` | la analítica, T2→T5 (`#735`), y la ficha de Google |
