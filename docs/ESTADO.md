...
> Suite **4414 en verde** (27.266 aserciones, 1 skipped a propósito), medida el **2026-09-07** sobre el
> árbol con **`#443`** —la hora extra cobrada POR INVITADO (**+22**: 19 casos nuevos de
> `StayExtensionPerGuestTest` y 3 reescritos o añadidos en `StayExtensionGuardsTest`)— encima de los
