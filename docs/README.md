...
| `specs/api-v1.md` | 🟦 Diseño de la API v1 (Fase 3), v2 tras revisión adversarial. **EJECUTADO**: los 6 pasos del corte cerrados; §9 lleva el avance y §10 → §10.quindecies lo que el código enseñó al implementar (80 puntos; los dos últimos lotes ya de Fase 4). |
