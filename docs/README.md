...
| `specs/api-v1.md` | 🟦 Diseño de la API v1 (Fase 3), v2 tras revisión adversarial. **EN EJECUCIÓN**: pasos 0, 1a, 1b y 2 cerrados; §9 lleva el avance y §10 → §10.quater lo que el código enseñó al implementar. |
