...
> tenía 100 entradas, de #100 a #199; el recuento vivo lo da `grep -cE '^## #[0-9]+ ·' docs/decisiones/100-199.md`.
...
**Sustituida por #618 (2026-09-16)** en su mitad del contador: la línea «Suite **N en verde**» de `ESTADO.md`
ya no existe y el hook compara la suite con el trailer del commit. La regla «una foto sin receta se retira» sigue.
