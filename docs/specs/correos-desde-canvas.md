...
> **Estado:** 🟦 **EL CARRIL ENTERO EN EL ÁRBOL, y son 26 correos, no 23** — T1 (vestido) · T2 (remitente) · T3+T4 (el MOLDE) · T5 (LA BANDEJA) · la FIESTA MIXTA (`#507`, §15) · **los DOS del framework que nadie había contado** (`#508`, §17) · y el **AVISO DE LA VÍSPERA** (`#717`, 2026-09-20), que lo trae el carril del SPA desde `specs/celebracion-e-invitacion.md` §10.17 y usa este molde sin tocarlo · y el **AVISO DEL ENLACE CON LA ANALÍTICA** (`AnalyticsLinkNotice`, T3a·4 de `specs/analitica.md` §4.3, 2026-09-24), también del carril del SPA y sobre este molde sin tocarlo: entra solo en el censo de la bandeja. **El inventario del artboard queda sin ningún RECHAZADO.** Sigue 🟦 solo por el OJO del owner en un cliente de correo real, y por los cuatro ÁMBAR (§16)
