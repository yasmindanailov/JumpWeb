...
| `/servicios` | ✅ existe · **mudada a la instancia** (`#660`) | `ServicesController` · la vista vive en `instancias/playjump/web/servicios.blade.php`; el producto sirve `anfitrion/servicios.blade.php` sin paquete |
