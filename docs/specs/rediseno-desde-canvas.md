...
| T3b… | **La página** que queda, en el orden del Layout: `/bar` | ⬜ ⚠️ Es NUEVA (ruta, controlador, vista y dato) y su pareja en la portada está fuera desde `#482`, así que hoy **no se llegaría a ella navegando**. El propio canvas declara que *«falla la tercera prueba de página»* |
