...
| **4.4a** | Identificación de un usuario **ya autenticado**. ⚠️ **Partido en DOS al implementarlo** (`DECISIONES #51`), como 4.2 y 4.3: **·1 el CTA pregunta quién eres y si puedes reservar** ✅ (2026-08-14) · **·2 la pantalla de identificación** | El corte es por DEPENDENCIA: de las cinco salidas de `checkout()` solo dos tienen pantalla hoy —el aviso de admisión y el cartel de pausa se pintan en el paso 4—; las otras tres llevan a los pasos 5 y 8, que son 4.4b y 4.5. El tramo ·1 transcribe la DECISIÓN sin navegar: navegar a un paso sin transcribir deja el cajón en blanco, que es peor que un CTA mudo |
