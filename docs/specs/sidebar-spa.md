...
| **4.4b** | Registro embebido + restauración de cesta. ⚠️ **Partido en DOS** (`DECISIONES #53`): **·1 el formulario de alta y el paso 7** ✅ (2026-08-14) · **·2 el widget de Turnstile**, aplazado porque no se puede verificar sin claves de Cloudflare y navegador; hasta entonces, con anti-bot activo el cajón delega el alta en el modal de Livewire | ⚠️ **El paso más peligroso**, y no el de pagar: es el único que cruza la frontera Livewire↔Vue en los dos sentidos (modal de auth y `account-context` son Livewire), y no tiene guardián en servidor |
