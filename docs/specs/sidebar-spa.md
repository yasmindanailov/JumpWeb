...
| **4.6** | Pasos 6, 10, 11 **y la vuelta de Redsys entera** (§4.1, costura 3). ⚠️ **Partido en DOS** (`DECISIONES #56`): **·1 el paso 6, la reserva creada** ✅ (2026-08-14) · **·2 los pasos 10 y 11**, denegado con su reintento y verificando con su sondeo | El corte es por DEPENDENCIA, como todos los anteriores: el sondeo del paso 11 aterriza en el paso 6, así que el 6 va primero. Hasta que 4.6 esté entero, quien pague con el flag activo vuelve a un cajón mudo: **no se despliega el flag** |
