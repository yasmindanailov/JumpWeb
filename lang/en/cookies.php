...
// Cookie consent banner and panel (#219).
...
return [
    'banner' => [
        ...
        'text' => 'We use our own cookies to make the site work and, only with your permission, third-party cookies to show the map, Google reviews and social media content.',
    ...
    'panel' => [
        ...
        'always_on' => 'Always on',
        'necessary_desc' => 'Essential for the session, form security and the shopping cart. They are exempt from consent.',
