...
return [
    ...
    'rates' => [
        ...
        'tip_label' => 'What the special rate is',
        'tip_days' => 'The special rate applies :days, plus the individual days the park marks.',
        'tip_calm' => 'Nothing to work out: when you pick the day, the price you see is yours.',
        'book_name' => 'Book :name',
        'zone_chip' => ':zone zone',
        'saving' => 'You save',
