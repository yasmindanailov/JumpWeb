...
return [
    ...
    'settings' => [
        ...
        'business_domain_hint' => 'Dominio que aparece en los textos legales (p. ej. jumpingjump.es). Si lo dejas vacío, se usa automáticamente el dominio desde el que se sirve la web.',
        ...
        'section_social_hint' => 'Enlaces de redes y feed de «@jumpingjump en directo».',
        ...
        'social_feed' => 'Feed «@jumpingjump en directo» (URL de inserción)',
        ...
        'social_feed_not_recognized' => 'No se reconoció una URL de inserción válida en el campo «Feed @jumpingjump»: el feed NO se ha cambiado. Pega el <iframe> de un widget de SnapWidget o LightWidget.',
        ...
        'seo_title_hint' => 'El título que se ve en la pestaña del navegador y en los resultados de Google para la portada. Ej.: «JUMPINGJUMP - Parque de saltos en Murcia». Vacío = título por defecto.',
