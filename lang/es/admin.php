...
return [
    ...
    // La analítica (`specs/analitica.md` §4.5, `#735`): el cuadro de mando. T2a, el dinero.
    'analytics' => [
        'nav_label' => 'Analítica',
        'title' => 'Analítica',
        ...
        'surveys' => [
            ...
            'col' => [
                ...
                'kind' => 'Clase',
                'state' => 'Estado',
                'answered_internal' => 'En la puerta',
                'answered_external' => 'Por correo',
                'question' => 'Pregunta',
                'option' => 'Respuesta',
                'answers' => 'Respuestas',
                'text' => 'Texto',
        ...
        'parties' => [
            ...
            'collected_in_park' => 'Cobrado en el parque',
            'with_extras' => 'Reservas con extras',
            'avg_extras' => 'Extras por reserva (media)',
            'completed' => 'Formularios completados',
            'on_time' => 'Dentro del plazo',
            'on_time_hint' => 'De los completados: :hours h o más antes de la fiesta',
            ...
            'invitation_heading' => 'La invitación y el justificante',
            'timing_heading' => 'Tiempos',
            'guests_heading' => 'Los invitados: dispositivo e idioma',
            'none' => '—',
            'step' => [
                'parties' => 'Fiestas del periodo',
                'form_opened' => 'Abrieron el formulario de invitados',
                'form_completed' => 'Completaron el formulario',
                'with_extras' => 'Compraron extras desde el formulario',
                'with_invitation' => 'Activaron la invitación digital',
                'invitation_viewed' => 'Alguien vio la invitación',
                'with_reply' => 'Recibieron alguna respuesta',
                'authorization_opened' => 'Alguien abrió el justificante',
                'signed' => 'Tienen algún justificante firmado',
            ],
            'step_short' => [
                'parties' => 'Fiestas',
                'form_opened' => 'Formulario abierto',
                'form_completed' => 'Completado',
                'with_extras' => 'Con extras',
                'with_invitation' => 'Con invitación',
                'invitation_viewed' => 'Invitación vista',
                'with_reply' => 'Con respuesta',
                'authorization_opened' => 'Justificante abierto',
                'signed' => 'Firmado',
            ],
            'row' => [
                'extras' => 'Extras del formulario',
                'guests' => 'Invitados añadidos y quitados',
                'guests_units' => ':added añadidos · :removed quitados',
                'guests_chart' => 'Invitados (+:added · −:removed)',
                'sold_after' => 'Vendido después de reservar (total)',
                'panel_edits' => 'Ediciones del panel (aparte, no son del formulario)',
                'collected_in_park' => 'Cobrado en el parque (efectivo o datáfono)',
                'with_extras' => 'Reservas con extras',
                'avg_extras' => 'Extras por reserva con extras (media)',
                'with_invitation' => 'Reservas con la invitación activada',
                'invitation_views' => 'Aperturas de la invitación (cargas)',
                'invitation_viewed' => 'Reservas con la invitación vista',
                'replies_yes' => 'Respuestas «sí»',
                'replies_no' => 'Respuestas «no»',
                'adopted' => 'Respuestas adoptadas por el anfitrión',
                'calendar' => 'Calendarios descargados (.ics)',
                'marked' => 'Reservas con justificante marcado al reservar',
                'openings' => 'Aperturas del justificante (cargas)',
                'opened' => 'Reservas con el justificante abierto',
                'signed' => 'Reservas con algún justificante firmado',
                'signatures' => 'Justificantes firmados',
                'from_invitation' => 'Firmados desde la invitación',
                'form_days_median' => 'Días antes de la fiesta al completar el formulario (mediana)',
                'on_time' => 'Completados :hours h o más antes de la fiesta',
                'sign_days_median' => 'Días antes de la fiesta al firmar el justificante (mediana)',
                'hours_since_open_median' => 'Horas entre abrir el justificante y firmarlo (mediana)',
            ],
            'days_bucket' => [
                'late' => 'Después de la fiesta',
                'same_day' => 'El mismo día',
                'd1_3' => 'De 1 a 3 días antes',
                'd4_7' => 'De 4 a 7 días antes',
                'd8_14' => 'De 8 a 14 días antes',
                'd15_plus' => '15 días o más antes',
            ],
            'col' => [
                'what' => 'Qué',
                'amount' => 'Importe',
                ...
                'step' => 'Paso',
                'reservations' => 'Reservas',
                'of_parties' => '% de las fiestas',
                'parties' => 'Fiestas',
                'completed' => 'Formularios completados',
                'invitations' => 'Con invitación',
                'replies_yes' => 'Respuestas «sí»',
                'signatures' => 'Justificantes',
        ...
        'delta' => [
            ...
            'same_previous' => 'Igual que el periodo anterior',
            'same_year_ago' => 'Igual que el año pasado',
            'none_previous' => 'Sin datos en el periodo anterior',
            'none_year_ago' => 'Sin datos el año pasado',
        ],
        // T2d: el CSV.
        'export' => [
            ...
            'compare_line' => 'Comparado con: :comparison',
            'summary' => 'Resumen',
        ],
        'money' => [
            ...
            'net' => 'Ingresos netos',
            'sold' => 'Vendido',
            'orders' => 'Pedidos cobrados',
            'avg_order' => 'Valor medio del pedido',
            'avg_collected' => 'Cobro medio online',
            'adjustments' => 'Gestiones posteriores',
            'adjustments_hint' => 'Cambios de cantidad, producto o fecha sobre pedidos ya cobrados, con signo',
            ...
            'buyers' => 'Compradores',
            'new' => 'Nuevos',
            'new_hint' => 'Su primer pedido cobrado cae en el periodo',
            'returning' => 'Recurrentes',
            'avg_per_customer' => 'Valor medio por cliente',
            'lifetime_avg' => 'Valor de vida medio',
            'lifetime_avg_hint' => 'Todo lo vendido a cada cliente con compra, de siempre',
            'breakdown_heading' => 'El desglose',
            'method_note' => 'Solo agregados: ningún nombre. El valor vivo de un pedido lo dice su libro.',
            'by_day' => 'Por día',
            'by_week' => 'Por semana',
            'by_channel' => 'Por canal',
            'by_method' => 'Por método de cobro',
            ...
            'method' => [
                ...
                'datafono' => 'Datáfono en taquilla',
                'other' => 'Otro',
            ],
            'deposit_rows' => [
                'orders' => 'Pedidos con señal',
                'pending' => 'Pendiente de cobrar en el parque',
                'settled' => 'Liquidado en el parque (inferido: la visita ya pasó)',
            ],
            'lost_rows' => [
                'expired' => 'Caducados sin pagar',
                'cancelled' => 'Cancelados',
                'declined' => 'Cobros rechazados por el banco',
                'incidents' => 'Incidencias de cobro',
            ],
            'col' => [
                'day' => 'Día',
                'week' => 'Semana',
        ...
        // T2b: los registros y la puerta.
        'customers' => [
            'registrations_heading' => 'Registros de clientes',
            'registrations' => 'Cuentas nuevas',
            'verified' => 'Con el correo verificado',
            'buyers' => 'Que han comprado alguna vez',
            'share' => ':percent % de las :total del periodo',
            'share_none' => 'Sin cuentas nuevas en el periodo',
            'gate_heading' => 'La puerta',
            'lookups' => 'Búsquedas en la puerta',
            'typed' => 'Tecleadas',
            'typed_hint' => 'Por correo o por teléfono',
            'scanned' => 'Escaneos de carné',
            'scanned_hint' => 'El código QR del cliente',
            'found' => 'Encontradas',
            'not_found_line' => 'No encontradas: :count',
            'customers' => 'Clientes distintos buscados',
            'customers_hint' => 'Una persona buscada varias veces cuenta una',
            'profile_views' => 'Fichas abiertas',
            'visits' => 'Visitas acreditadas',
            'visitors' => 'Clientes con visita acreditada',
            'visitors_hint' => 'Una por cliente y día, con el botón de la puerta',
            'series_heading' => 'Cuentas nuevas, clientes buscados y visitas acreditadas por :granularity',
            'series' => [
                'registrations' => 'Cuentas nuevas',
                'customers' => 'Clientes buscados',
                'visits' => 'Visitas acreditadas',
            ],
        ...
        'traffic' => [
            ...
            'identified_hint' => 'Atadas a una cuenta, solo con la categoría «análisis» consentida',
            'excluded' => 'Fuera del recuento',
            'excluded_value' => ':bots bots · :internal internas',
            'excluded_hint' => 'Rastreadores, la sonda y el equipo del parque',
            ...
            'step' => [
                'visits' => 'Visitas',
                'interest' => 'Interés (abren el cajón o contactan)',
                'intent' => 'Intención (eligen un día)',
                'cart' => 'Cesta (añaden una línea)',
                'identified' => 'Identificadas (entran o se registran)',
                'pay_started' => 'Pago iniciado (van al banco)',
            ],
            'left_at' => [
                'visit' => 'Solo miraron',
                'interest' => 'Tras abrir el cajón o contactar',
                'intent' => 'Tras elegir un día',
                'cart' => 'Con algo en la cesta',
            ...
            'series_heading' => 'Visitas y compras por :granularity',
            'series' => [
                'visits' => 'Visitas',
                'purchases' => 'Compras',
            ],
            ...
            'devices' => 'Dispositivo',
            'locales' => 'Idioma',
            'products' => 'Productos elegidos en el cajón',
            ...
            'contact' => [
                'contact_received' => 'Formularios de contacto recibidos',
                'contact_form_started' => 'Formularios empezados',
                'call_clicked' => 'Toques en «Llamar»',
                'whatsapp_clicked' => 'Toques en WhatsApp',
                'map_clicked' => 'Toques en el mapa',
            ],
            'rejected_heading' => 'Eventos rechazados por la ingesta (últimos :days días)',
            'rejected_reason' => [
                'unknown_event' => 'Nombre que no existe en el contrato',
                'server_only' => 'Un hecho de servidor mandado desde el cliente',
                'bad_event_id' => 'Identificador mal formado',
                'pii' => 'Con pinta de dato personal',
                'malformed' => 'Mal formados',
            ],
            'rejected_total' => 'Total rechazados',
            'dropped_events' => 'Tirados por el navegador sin poder enviarlos (en el periodo)',
            'no_route' => '(sin ruta)',
            'no_data' => 'Sin dato',
            'col' => [
                'step' => 'Paso',
