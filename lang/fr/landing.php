...
return [
    ...
    'reviews' => [
        ...
        'lede_profile' => 'Les plus récents de notre fiche Google.',
        'anonymous' => 'Utilisateur Google',
        'reply' => 'Réponse du propriétaire',
        'photo_alt' => 'Photo :n sur :total de l\'avis de :name',
        'as_of' => 'Au :date',
        'count_on_google' => '{1} :n avis sur Google|[2,*] :n avis sur Google',
        'via_google' => 'Publié sur Google',
        'filtered' => 'Nous affichons les avis de :stars étoiles ou plus. Ni nous ni Google ne vérifions que leurs auteurs sont venus.',
        'see_all' => 'Voir tous les avis sur Google',
