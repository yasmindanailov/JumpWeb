...
return [
    ...
    'rates' => [
        ...
        'tip_label' => 'Ce qu\'est le tarif spécial',
        'tip_days' => 'Le tarif spécial s\'applique :days, ainsi que les jours que le parc signale.',
        'tip_calm' => 'Rien à calculer : en choisissant le jour, le prix affiché est le vôtre.',
