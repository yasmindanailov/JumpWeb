...
return [
    'proof' => [
        ...
        'subject_dependent' => 'Un mineur à sa charge : :name (né le :born_on)',
        'subject_dependent_note' => "Les données du mineur ont été déclarées par le titulaire du compte en l'ajoutant à son compte et n'ont pas été vérifiées par des moyens externes. Elles sont copiées ici telles qu'elles étaient au moment de l'acceptation.",
        ...
        'first_link' => 'Premier registre de ce sujet (sans précédent)',
        ...
        'verification_note' => 'La vérification est interne : le registre est une chaîne d\'empreintes par sujet (le titulaire, ou chaque mineur à sa charge) (SHA-256, sans secret) conservée dans la base de données de l\'application, sans horodatage qualifié ni ancrage auprès d\'un tiers. Elle détecte les altérations accidentelles ou faites par l\'application ; elle ne protège pas contre qui peut écrire directement dans la base de données.',
