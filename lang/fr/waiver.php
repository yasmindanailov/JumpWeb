...
return [
    'proof' => [
        ...
        'subject_guest_minor' => 'Un mineur INVITÉ à une réservation : :name (date de naissance :born_on). Ce n’est pas une personne à charge de qui a réservé.',
        'signer' => 'Qui accepte (adulte responsable du mineur)',
        'signer_contact' => 'Coordonnées de qui accepte',
        'responsible' => 'Personne titulaire de la réservation',
        'booking' => 'Réservation',
        'subject_guest_minor_note' => 'Cette acceptation n’a PAS été enregistrée par la personne titulaire de la réservation : elle l’a été par un adulte qui déclare être le parent ou le tuteur légal du mineur et qui n’a PAS de compte dans ce système. Ni son identité, ni son adresse e-mail, ni les données du mineur n’ont été vérifiées par un moyen externe : elles sont copiées ici telles qu’écrites au moment de l’acceptation. Ce que ce registre prouve, c’est que le texte lui a été présenté et qu’elle l’a accepté explicitement.',
