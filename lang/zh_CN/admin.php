...
return [
    ...
    'orders' => [
        ...
        'create_manual' => [
            ...
            'done_mail_title' => '已通过邮件发送',
            'done_mail_confirmation' => '订单确认已发送至 :email',
            'done_mail_guest_form' => '{1} 该预订的宾客表单|[2,*] :count 个预订的宾客表单',
            'done_mail_guardian' => '{1} 受邀未成年人的授权书|[2,*] :count 个预订的受邀未成年人授权书',
            'done_no_mail_title' => '该客户没有邮箱：未发送任何内容',
            'done_no_mail_body' => '确认函、宾客表单和授权书都未发送。请通过 WhatsApp 或短信把下面的链接交给他。',
            'done_links_title' => '需当面交付的链接',
            'done_link_guest_form' => '宾客表单 · :product',
            'done_link_guardian' => '受邀未成年人授权书 · :product',
