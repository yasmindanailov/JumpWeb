...
return [
    ...
    'orders' => [
        ...
        'mixed_party' => [
            ...
            'drift' => '已记录的补差价为 :written,按当前配置应为 :derived。系统不会自动重算:已记录的金额就是告知客户的金额。',
            ...
            'out_of_range' => ':count 位来宾的年龄不属于该家族的任何套餐:请在产品目录中检查年龄段。',
            'orphaned' => '此套餐已不属于任何年龄家族,因此没有可比对的判定结果。上方的补差仍然有效:那是已经通知客户的金额,也是到场时应收取的金额。',
        ],
    ...
    'catalog' => [
        ...
        'guest_age_family_hint' => '把本套餐与同一服务、不同年龄段的套餐关联起来(例如在儿童场和青少年场都填「cumple」)。仅限小写字母、数字和连字符。留空 = 本产品不区分年龄,也不会提出补差价。',
