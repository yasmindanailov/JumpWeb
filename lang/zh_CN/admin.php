...
return [
    ...
    'settings' => [
        ...
        'business_domain_hint' => '出现在法律文本中的域名（例如 jumpingjump.es）。留空则自动使用提供网站的域名。',
        ...
        'section_social' => '社交媒体',
        'section_social_hint' => '社交链接和「@jumpingjump 实时」动态。',
        'contact_email' => '联系邮箱',
        'contact_phone' => '电话',
        ...
        'social_feed' => '「@jumpingjump 实时」动态（嵌入网址）',
        ...
        'social_feed_not_recognized' => '「@jumpingjump 动态」字段中未识别到有效的嵌入网址：动态未更改。请粘贴 SnapWidget 或 LightWidget 小组件的 <iframe> 代码。',
        ...
        'seo_title_hint' => '首页在浏览器标签页和谷歌搜索结果中显示的标题。例如：「JUMPINGJUMP - Parque de saltos en Murcia」。留空 = 默认标题。',
