 ...
 * servidor al pagar (`line_sold_out`) y se enseña en el propio paso.
 */
...
export function usePagoCompra({ flow, props, textos = {}, compra, enCola, alPagarMal }) {
     ...
     * —como en la pantalla 0— y el dinero, cuando llega; si el servidor dice que no, vuelve la de antes.
     */
    async function rehacer(cambio) {
        ...
        Object.assign(compra.borrador, { n: compra.pedido.n, cal: p.cal });
    }
