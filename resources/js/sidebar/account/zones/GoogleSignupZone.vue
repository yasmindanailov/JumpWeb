...
<template>
    <div class="auth">
        ...
        <template v-if="ui.expired">
            ...
            <a v-if="urls.google" class="btn btn--ink auth__submit" :href="urls.google">{{ a('google.restart') }}</a>
        </template>
        ...
        <template v-else-if="ui.pending">
            ...
            <form class="form auth__form" novalidate @submit.prevent="submit">
                ...
                <button type="submit" class="btn btn--ink auth__submit" :disabled="ui.busy">
