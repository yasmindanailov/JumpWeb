{{-- Precios · `ui/precios` del artboard `Iconos PJP` (§02 SET UI).
...
<svg {{ $attributes->merge(['width' => 24, 'height' => 24]) }} viewBox="0 0 24 24" fill="currentColor"
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.9 2.6H19A2.4 2.4 0 0 1 21.4 5v5.1a2.4 2.4 0 0 1-.7 1.7l-8.9 8.9a2.4 2.4 0 0 1-3.4 0l-4.4-4.4a2.4 2.4 0 0 1 0-3.4l8.9-8.9a2.4 2.4 0 0 1 1.7-.7zm2.8 3.1a1.8 1.8 0 1 0 0 3.6 1.8 1.8 0 0 0 0-3.6z" />
</svg>
