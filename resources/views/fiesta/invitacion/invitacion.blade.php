...
@endphp
<div class="inv-card">
    <x-fiesta.invitacion :theme="$m['tema']['clave']" :name="$m['cumple']['nombre']" :age="$m['cumple']['edad']" :date="$m['fecha']" :time="$m['hora']" :place="$m['lugar']" :host="$inv['linea']" :words="$inv['palabras']" :gifts="$inv['pistas']" :phone="$inv['telefono']" :phoneHref="$inv['tel']" titleTag="h1" animate data-invitation-card :data-theme="$m['tema']['clave']">
