...
<a href="{{ route('legal.privacidad') }}" style="color:#626A72;text-decoration:underline;">{{ $legal[1] ?? 'Privacidad' }}</a>
&nbsp;&middot;&nbsp;
<a href="{{ route('legal.condiciones') }}" style="color:#626A72;text-decoration:underline;">{{ $legal[2] ?? 'Condiciones' }}</a>
&nbsp;&middot;&nbsp;
<a href="{{ route('legal.cookies') }}" style="color:#626A72;text-decoration:underline;">{{ $legal[3] ?? 'Cookies' }}</a>
&nbsp;&middot;&nbsp;
<a href="{{ route('contacto') }}" style="color:#626A72;text-decoration:underline;">{{ __('landing.footer.contact_link') }}</a>
</p>
</td>
</tr>
</table>
