 ...
 */
class ParkScheduleTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $hours = (new ParkSchedule)->effectiveFor($this->date);
    ...
    public function test_closed_weekday(): void
    {
        ...
        $this->assertFalse((new ParkSchedule)->isOpenOn($this->date));
    }
    ...
    public function test_overlapping_seasons_earliest_start_wins(): void
    {
        ...
        $hours = (new ParkSchedule)->effectiveFor(Carbon::parse('2026-07-15'));
        $this->assertSame('11:00:00', $hours['open']);
    }
    ...
    public function test_single_day_season_applies_only_that_day(): void
    {
        ...
        $this->assertSame('11:00:00', (new ParkSchedule)->effectiveFor(Carbon::parse('2026-06-10'))['open']); // ese día
        $this->assertSame('16:00:00', (new ParkSchedule)->effectiveFor(Carbon::parse('2026-06-11'))['open']); // día siguiente → semanal
    }
}
